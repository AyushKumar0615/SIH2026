...
export default function FaceRelationGame({ onFinishGame, onBack }) {
  ...
  return (
    <div className="page max-w-2xl">
      ...
      <span className="eyebrow">Family Recall</span>
      ...
      <button type="button" disabled={submitted} onClick={finish} className="btn btn-ember w-full mt-8">Complete Family Match</button>
    </div>
  );
}
